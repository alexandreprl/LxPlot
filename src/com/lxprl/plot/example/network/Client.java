...
public class Client {
	...
	public static void main(String[] args) {
		...
		LxPlot.getServer("My server").getChart("My chart").add("My serie", 3, 2.5);
		LxPlot.getServer("My server").getChart("My chart").add("My serie", 5, 2);

		// Preconfigure chart by setting name and type
		LxPlot.getServer("My server").configChart("My chart 2",
				ChartType.PLOT);
